...
export const ACHIEVEMENTS: AchievementDefinition[] = [
    ...
    {
        id: "ach_quest-set-master",
        name: "Daily Quest Master",
        description: "Walk the daily path, completing all five quests and claiming the spirits' bounty bonus each cycle",
        category: 2,
        type: 1,
        subType: "quest_set_completion",
        milestones: [
            { index: 0, name: "Devoted Seeker", description: "Claim the bonus reward after completing all 5 daily quests", requirement: 1, badgeUri: "badges/streak/quest-1.png" },
            { index: 1, name: "Weekly Pilgrim", description: "Complete and claim the daily bonus 7 times", requirement: 7, badgeUri: "badges/streak/quest-7.png" },
            { index: 2, name: "Lunar Devotee", description: "Complete and claim the daily bonus 30 times", requirement: 30, badgeUri: "badges/streak/quest-30.png" },
            { index: 3, name: "Centurion of Quests", description: "Complete and claim the daily bonus 100 times", requirement: 100, badgeUri: "badges/streak/quest-100.png" },
            { index: 4, name: "Year of the Spirits", description: "Complete and claim the daily bonus 365 times", requirement: 365, badgeUri: "badges/streak/quest-365.png" },
        ],
    },
    {
        id: "ach_theme-master",
        name: "Cycle Walker",
        description: "Honor the rotating themes — claim affinity and domain quests across every cycle the Ancients reveal",
        category: 2,
        type: 1,
        subType: "themed_quest_claim",
        milestones: [
            { index: 0, name: "Theme Apprentice", description: "Claim 10 themed daily quests (affinity or domain)", requirement: 10, badgeUri: "badges/streak/theme-10.png" },
            { index: 1, name: "Pathwalker", description: "Claim 30 themed daily quests", requirement: 30, badgeUri: "badges/streak/theme-30.png" },
            { index: 2, name: "Thematic Sage", description: "Claim 90 themed daily quests", requirement: 90, badgeUri: "badges/streak/theme-90.png" },
            { index: 3, name: "Master of the Cycle", description: "Claim 270 themed daily quests", requirement: 270, badgeUri: "badges/streak/theme-270.png" },
        ],
    },
    {
    ...
    {
        id: "ach_challenge-mastery",
        name: "Mastery Climber",
        description: "Every tier you raise echoes across your whole roster — climb the mastery ranks to forge challenges into a true path of power",
        category: 4,
        type: 1,
        subType: "challenge",
        milestones: [
            { index: 0, name: "Mastery Climber I", description: "Earn your first mastery tier on any challenge", requirement: 1, badgeUri: "badges/challenge/mastery-1.png" },
            { index: 1, name: "Mastery Climber II", description: "Earn 5 mastery tiers across your challenges", requirement: 5, badgeUri: "badges/challenge/mastery-5.png" },
            { index: 2, name: "Mastery Climber III", description: "Earn 15 mastery tiers — your dedication reshapes the trials", requirement: 15, badgeUri: "badges/challenge/mastery-15.png" },
            { index: 3, name: "Mastery Climber IV", description: "Earn 30 mastery tiers — half the path to total mastery", requirement: 30, badgeUri: "badges/challenge/mastery-30.png" },
            { index: 4, name: "Mastery Climber V", description: "Earn 60 mastery tiers — every challenge at Diamond, the completionist's crown", requirement: 60, badgeUri: "badges/challenge/mastery-60.png" },
        ],
    },
    {
        id: "ach_challenge-gold",
        name: "First Gold",
        description: "Raise a single challenge to Gold mastery — and unlock the power to push past your stage",
        category: 4,
        type: 0,
        subType: "challenge",
        badgeUri: "badges/challenge/gold.png",
    },
    {
        id: "ach_challenge-grandmaster",
        name: "Grandmaster",
        description: "Take all 12 challenges to Diamond mastery — the deepest, longest mastery chase in the realm",
        category: 4,
        type: 0,
        subType: "challenge",
        badgeUri: "badges/challenge/grandmaster.png",
    },
    {
    ...
    {
        id: "ach_fusion-progression",
        name: "Forge Mastery",
        description: "Master the ancient art of totem fusion — combine lesser totems to forge beings of ever greater power",
        category: 6,
        type: 1,
        subType: "fusion",
        milestones: [
            { index: 0, name: "First Forge", description: "Complete your first totem fusion", requirement: 1, badgeUri: "badges/forge/1.png" },
            { index: 1, name: "Apprentice Smith", description: "Complete 5 fusions — the forge fire burns steadily under your watch", requirement: 5, badgeUri: "badges/forge/5.png" },
            { index: 2, name: "Journeyman Forger", description: "Complete 10 fusions — your hands shape power with growing confidence", requirement: 10, badgeUri: "badges/forge/10.png" },
            { index: 3, name: "Master Forger", description: "Complete 25 fusions — the spirits themselves guide your craft", requirement: 25, badgeUri: "badges/forge/25.png" },
            { index: 4, name: "Legendary Smith", description: "Complete 50 fusions — your forge has become a beacon of transformation", requirement: 50, badgeUri: "badges/forge/50.png" },
            { index: 5, name: "Eternal Artisan", description: "Complete 100 fusions — the forge fire has become an extension of your will", requirement: 100, badgeUri: "badges/forge/100.png" },
            { index: 6, name: "Forge Transcendent", description: "Complete 250 fusions — you have transcended the boundaries of mortal craftsmanship", requirement: 250, badgeUri: "badges/forge/250.png" },
        ],
    },
    {
        id: "ach_pure-fusion",
        name: "Bloodline Keeper",
        description: "Preserve the purity of a species through fusion — only the most dedicated keepers master the art of pure fusion",
        category: 6,
        type: 1,
        subType: "pure_fusion",
        milestones: [
            { index: 0, name: "Purebred", description: "Complete your first pure fusion — same species in, same species out", requirement: 1, badgeUri: "badges/forge/pure-1.png" },
            { index: 1, name: "Species Master", description: "Complete 3 pure fusions — your dedication to bloodline purity is unmatched", requirement: 3, badgeUri: "badges/forge/pure-3.png" },
            { index: 2, name: "Bloodline Keeper", description: "Complete 5 pure fusions — you've mastered the art of preserving species through transformation", requirement: 5, badgeUri: "badges/forge/pure-5.png" },
            { index: 3, name: "Lineage Guardian", description: "Complete 10 pure fusions — ancestral spirits recognize your devotion to their bloodlines", requirement: 10, badgeUri: "badges/forge/pure-10.png" },
            { index: 4, name: "Ancestral Forger", description: "Complete 25 pure fusions — you are the unbroken chain linking past and future", requirement: 25, badgeUri: "badges/forge/pure-25.png" },
        ],
    },
    {
        id: "ach_wild-fusion",
        name: "Chaos Alchemist",
        description: "Embrace the unpredictable — mix species freely and let the forge decide what emerges from the flames",
        category: 6,
        type: 1,
        subType: "wild_fusion",
        milestones: [
            { index: 0, name: "First Experiment", description: "Complete your first wild fusion — who knows what will emerge?", requirement: 1, badgeUri: "badges/forge/wild-1.png" },
            { index: 1, name: "Chaos Mixer", description: "Complete 3 wild fusions — you're growing comfortable with uncertainty", requirement: 3, badgeUri: "badges/forge/wild-3.png" },
            { index: 2, name: "Wild Alchemist", description: "Complete 5 wild fusions — the randomness has become your greatest tool", requirement: 5, badgeUri: "badges/forge/wild-5.png" },
            { index: 3, name: "Entropy Weaver", description: "Complete 10 wild fusions — you harness chaos itself as a creative force", requirement: 10, badgeUri: "badges/forge/wild-10.png" },
            { index: 4, name: "Primordial Shaper", description: "Complete 25 wild fusions — from raw disorder you birth magnificent creatures", requirement: 25, badgeUri: "badges/forge/wild-25.png" },
        ],
    },
    {
        id: "ach_rare-forger",
        name: "Rare Forger",
        description: "Forge your first Rare totem — a significant step up the rarity ladder",
        category: 6,
        type: 0,
        subType: "forge_rarity",
        badgeUri: "badges/forge/rare-forger.png",
    },
    {
        id: "ach_epic-forger",
        name: "Epic Forger",
        description: "Forge your first Epic totem — only the most skilled smiths reach this level of mastery",
        category: 6,
        type: 0,
        subType: "forge_rarity",
        badgeUri: "badges/forge/epic-forger.png",
    },
    {
        id: "ach_legendary-forger",
        name: "Legendary Forger",
        description: "Forge your first Legendary totem — the pinnacle of the forger's art, a feat whispered about in legends",
        category: 6,
        type: 0,
        subType: "forge_rarity",
        badgeUri: "badges/forge/legendary-forger.png",
    },
    {
        id: "ach_first-elder",
        name: "First Among Equals",
        description: "Seat your first totem in the Elder Sanctum — a place of honor reserved for only the most powerful spirits",
        category: 7,
        type: 0,
        subType: "sanctum",
        badgeUri: "badges/sanctum/first-elder.png",
    },
    {
        id: "ach_full-council",
        name: "Full Council",
        description: "Fill all three seats of the Elder Sanctum, assembling a complete council of ascended totems",
        category: 7,
        type: 1,
        subType: "sanctum",
        milestones: [
            { index: 0, name: "Full Council", description: "Seat 3 totems in the Elder Sanctum simultaneously", requirement: 3, badgeUri: "badges/sanctum/full-council.png" },
        ],
    },
    {
        id: "ach_sanctum-claim",
        name: "Council Tithe",
        description: "Claim the Essence generated by your seated elders — the sanctum rewards those who tend to their council",
        category: 7,
        type: 1,
        subType: "sanctum_claim",
        milestones: [
            { index: 0, name: "First Tithe", description: "Claim sanctum earnings for the first time", requirement: 1, badgeUri: "badges/sanctum/tithe-1.png" },
            { index: 1, name: "Tithe Collector", description: "Claim sanctum earnings 10 times", requirement: 10, badgeUri: "badges/sanctum/tithe-10.png" },
            { index: 2, name: "Sanctum Treasurer", description: "Claim sanctum earnings 50 times", requirement: 50, badgeUri: "badges/sanctum/tithe-50.png" },
            { index: 3, name: "Grand Treasurer", description: "Claim sanctum earnings 100 times", requirement: 100, badgeUri: "badges/sanctum/tithe-100.png" },
            { index: 4, name: "Eternal Treasurer", description: "Claim sanctum earnings 500 times — your treasury overflows with ancient power", requirement: 500, badgeUri: "badges/sanctum/tithe-500.png" },
        ],
    },
    {
        id: "ach_tenure-master",
        name: "Long Reign",
        description: "Keep your totems seated in the Elder Sanctum for extended periods, building tenure and deepening their bond with the council",
        category: 7,
        type: 1,
        subType: "sanctum_tenure",
        milestones: [
            { index: 0, name: "Week Watch", description: "Maintain a totem in the sanctum for 7 days", requirement: 7, badgeUri: "badges/sanctum/tenure-7.png" },
            { index: 1, name: "Fortnight Keeper", description: "Maintain a totem in the sanctum for 14 days", requirement: 14, badgeUri: "badges/sanctum/tenure-14.png" },
            { index: 2, name: "Long Reign", description: "Maintain a totem in the sanctum for 30 days", requirement: 30, badgeUri: "badges/sanctum/tenure-30.png" },
        ],
    },
    {
        id: "ach_council-missions",
        name: "Council Veteran",
        description: "Complete council missions to prove your worth as a leader of the Elder Sanctum",
        category: 7,
        type: 1,
        subType: "council_mission",
        milestones: [
            { index: 0, name: "Mission Initiate", description: "Complete 5 council missions", requirement: 5, badgeUri: "badges/sanctum/mission-5.png" },
            { index: 1, name: "Council Veteran", description: "Complete 25 council missions", requirement: 25, badgeUri: "badges/sanctum/mission-25.png" },
            { index: 2, name: "Elder Diplomat", description: "Complete 50 council missions — your diplomatic skill is unmatched", requirement: 50, badgeUri: "badges/sanctum/mission-50.png" },
            { index: 3, name: "Grand Elder", description: "Complete 100 council missions — you have earned the respect of all spirits", requirement: 100, badgeUri: "badges/sanctum/mission-100.png" },
            { index: 4, name: "Eternal Elder", description: "Complete 500 council missions — your legacy echoes through eternity", requirement: 500, badgeUri: "badges/sanctum/mission-500.png" },
        ],
    },
    {
        id: "ach_founding-ritual",
        name: "World Founder",
        description: "Complete the legendary Founding Ritual council mission — only the most dedicated elders attempt this ancient rite",
        category: 7,
        type: 0,
        subType: "council_mission",
        badgeUri: "badges/sanctum/founding-ritual.png",
    },
];
